...
@overload
def average(a: ArrayLike, axis: _Axis = None, weights: Optional[ArrayLike] = None,
...
def block(arrays: Union[ArrayLike, list[ArrayLike], list[list[ArrayLike]]]) -> Array: ...
bool_: Any
...
def histogram2d(
    x: ArrayLike,
    y: ArrayLike,
    bins: Union[ArrayLike, list[ArrayLike]] = ...,
...
def squeeze(
    a: ArrayLike, axis: Optional[Union[int, tuple[int, ...]]] = None
) -> Array: ...
def stack(
    arrays: Union[_np.ndarray, Array, Sequence[ArrayLike]],
    axis: int = ...,
